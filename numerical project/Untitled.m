...
feature = data_feature("C:\Users\lukeg\Desktop\numerical project\abalone.data", [1, Inf]);
label = data_label("C:\Users\lukeg\Desktop\numerical project\abalone.data", [1, Inf]);


species_num = grp2idx(label);
%%
...
t = templateSVM('Standardize',true,'KernelFunction','gaussian','SaveSupportVectors', true);
...
t = templateSVM('Standardize',true,'KernelFunction','gaussian','SaveSupportVectors', true);
Md1 = fitcecoc(X_train_w_best_feature,y_train,'Learner',t,'OptimizeHyperparameters','auto',...
